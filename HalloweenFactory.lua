...
-- Function to find any ClickDetector in the house
local function findAndFireClickDetector(house)
    local houseObj = workspace.Houses:FindFirstChild(house)
    if houseObj then
        -- Iterate over all children to find a ClickDetector
        for _, child in pairs(houseObj:GetChildren()) do
            ...
            if clickDetector then
                ...
                return true -- Found and fired a ClickDetector
            end
        end
    end
...
local function teleportToHouses()
    ...
    for houseName, houseCFrame in pairs(houses) do
        ...
        -- Find and fire the ClickDetector
        findAndFireClickDetector(houseName)
