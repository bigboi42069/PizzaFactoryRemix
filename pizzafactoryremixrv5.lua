...
camframe=Create("Frame",gui,{Name="camframe", BackgroundTransparency=1, Size=UDim2.new(0,120,0,40), Position=UDim2.new(0.5,-500,0,-38), BackgroundColor3=Color3.new(0.118,0.118,0.118)})
